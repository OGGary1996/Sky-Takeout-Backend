...
// 由于用户端存在同样的 ShopController，所以这里需要修改Bean名称
...
public class ShopController {
    ...
    /*
    * 设置店铺的营业状态
    * @param @PathVariable Integer status
    * @return Result<String>
    * */
    @Operation(summary = "Set Shop Status" , description = "Set the operational status of the shop")
    @PutMapping("/{status}")
